...
class Sender(Bottle):
    ...
    def register_message(self, subject, message):
        SQL = 'INSERT INTO emails (email_subject, email_message) VALUES (%s, %s)'
    ...
    def send(self):
        ...
        return 'Message sent! Subject: {} Message: {}'.format(subject, message)

if __name__ == '__main__':
    sender = Sender()
    sender.run(host='0.0.0.0', port=8080, degbug=True)